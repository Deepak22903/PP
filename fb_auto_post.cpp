...
string CLOUDFLARE_ACCOUNT_ID = "d03ba4adab44b19322eed9dd5a40de7d";
string CLOUDFLARE_AUTH_TOKEN = "MkPwb3osbvgKuSWn8XR43dnk3vAs2VW-EgXZ_pek";
string FB_PAGE_ID = "555233441009283";
...
void generateImage(string prompt) {
  ...
  if (!decoded.empty()) {
    ofstream file("result.jpg", ios::binary);
